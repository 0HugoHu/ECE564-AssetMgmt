...
public extension UIImage {
    ...
    class func imageNamed(_ name: String?, bundleForClass: AnyClass?, bundleName: String? = "SwiftyFileBrowser") -> UIImage? {
...
public extension UIImage {
    ...
    /// - Returns: 转换后的灰度图片
    func dfa_greyScaleImage() -> UIImage? {
    ...
    /// - Returns: 转换后的灰度图片
    func dfa_greyScaleAlphaImage() -> UIImage? {
